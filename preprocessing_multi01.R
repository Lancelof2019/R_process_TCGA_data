...
tried_groups<-c("BLCA",  "COAD",  "KICH", "KIRC", "KIRP","SKCM","LIHC","LUAD","LUSC","UCEC","READ","PAAD","BRCA","ESCA","STAD")
still_groups<-c( )
not_installed<-c("THYM","THCA",)
...
print(cancer_type)
TCGAanalyze_survival(survivalInfo_tmp, clusterCol = "hc", color = c("#33A02C","#1F78B4","#E31A1C","#AC4B1C","#FFD57E","#EE3388","#345565"), filename = paste0("./figure/surv_analysis/",cancer_type,"_survival_analysis02.pdf"), conf.int = F, width = 7, height = 7)

TCGAanalyze_survival(survivalInfo_tmp, clusterCol = "shortLetterCode", filename = paste0("./figure/surv_analysis/",cancer_type,"_survival_analysis_tumorType03.pdf"), conf.int = F, width = 7, height = 7)

#TCGAanalyze_survival(survivalInfo, clusterCol = "tumor_stage", filename = paste0("./figure/surv_analysis/",cancer_type,"_survival_analysis_tumorStage03.pdf"), conf.int = F, width = 7, height = 7)
