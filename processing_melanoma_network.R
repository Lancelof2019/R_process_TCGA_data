...
saveRDS(graph_comp, "./data/network_processed/test_graph_comp.RData")
#plot(graph_comp)
vis_network <- visIgraph(graph_comp)
visSave(vis_network, file = "./data/network_processed/melanoma_network.html")
